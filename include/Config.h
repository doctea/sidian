...
/*#ifndef ENABLE_SCREEN
    ...
    #define PIN_BUTTON_A    D25   // pin to receive encoder button
    #ifdef BUILD_BREADBOARD
        #define PIN_BUTTON_B    D26   // pin to receive back button    //;; breadboard version has DC on D0, and back button on D9
