...
void setup_menu(bool button_high_state = HIGH) {
    ...
    #ifdef PIN_BUTTON_A
        pushButtonA.attach(PIN_BUTTON_A, PinMode::INPUT_PULLDOWN);
        pushButtonA.interval(5);
        pushButtonA.setPressedState(button_high_state);
    #endif
    #ifdef PIN_BUTTON_B
        pushButtonB.attach(PIN_BUTTON_B, PinMode::INPUT_PULLDOWN);
        pushButtonB.interval(5);
        pushButtonB.setPressedState(button_high_state);
    #endif
    #ifdef PIN_BUTTON_C
        pushButtonC.attach(PIN_BUTTON_C, PinMode::INPUT_PULLDOWN);
        pushButtonB.interval(5);
        pushButtonB.setPressedState(button_high_state);
    #endif
